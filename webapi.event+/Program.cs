...
// habilita o serviço de conteúdo do Azure 
builder.Services.AddSingleton(provider => new ContentModeratorClient
(
    new ApiKeyServiceClientCredentials("06231a17558748658a4555f4ec009e4b"))
{
    Endpoint = "https://eventcontentmoderatorgabriel.cognitiveservices.azure.com/"
}
